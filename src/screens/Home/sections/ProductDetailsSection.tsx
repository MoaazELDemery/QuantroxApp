      ...
      <div className="relative z-10 flex flex-col gap-20 container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex flex-col items-center justify-center gap-16">
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            text-5xl text-center tracking-[0] leading-normal">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {productCards.map((card, index) => (
              <Card
                key={index}
                className="w-96 bg-[#00000033] border-none rounded-2xl overflow-hidden 
                backdrop-blur-[15px] backdrop-brightness-[100%] 
                [-webkit-backdrop-filter:blur(15px)_brightness(100%)]"
              >
        ...
        px-6 sm:px-12 py-12 sm:py-20">
          <div className="flex flex-col items-center gap-8 max-w-[1099px] mx-auto">
            <header className="flex flex-col items-center gap-8 text-center">
              <h2 className="[font-family:'Satoshi-Bold',Helvetica] font-bold text-[#e6e6e6] 
                  text-5xl tracking-[-1.80px] leading-normal">
                Wall Street Grade. Architected for Egypt.
              </h2>

              <p className="[font-family:'Satoshi-Medium',Helvetica] font-medium text-[#d9d9d9] 
                  text-[22px] tracking-[0] leading-normal max-w-full">
                    ...
                    <CardContent className="p-0">
                      <div className="relative h-[401px] w-full sm:w-[990px]">
                        ...
                        > */}
                          ...
                          />
                          <img
                            className="w-[120px] h-[120px] sm:w-[217px] sm:h-[217px] rounded-[20px] 
                                object-cover absolute top-[30px] left-1/2 sm:top-[86px] 
                                sm:left-[202px] -translate-x-1/2 sm:translate-x-0 z-10"
                            alt={`${member.name} avatar`}
                            src={member.avatar}
                          />
                          <div className="flex flex-col gap-3 max-w-full sm:max-w-[551px] 
                              absolute top-[170px] left-1/2 -translate-x-1/2 sm:top-[90px] sm:right-[60px] 
                              sm:left-auto sm:translate-x-0 w-[90%] sm:w-auto items-center sm:items-start 
                              text-center sm:text-left">
                            <div className="flex flex-col gap-1">
                              <h3 className="[font-family:'Satoshi-Medium',Helvetica] font-medium 
                                  text-[#ffffff] text-xl sm:text-2xl tracking-[0] leading-normal">
                                {member.name}
                              </h3>
                              <p className="[font-family:'Inter',Helvetica] font-normal text-[#ffffffb2] 
                                  text-xs sm:text-sm tracking-[0] leading-normal">
                                {member.title}
                              </p>
                            </div>
                            <p className="[font-family:'Satoshi-Regular',Helvetica] font-normal 
                                text-[#ffffff] text-base sm:text-xl tracking-[0] leading-normal 
                                max-w-full sm:max-w-[490px]">
                              {member.description}
                            </p>
                            <div className="inline-flex items-center gap-2 justify-center sm:justify-start">
                              ...
                              <span className="[font-family:'Satoshi-Regular',Helvetica] font-normal 
                                  text-sm sm:text-base underline text-[#ffffff] tracking-[0] leading-normal">
                                {member.linkedinUrl}
                              </span>
                            </div>
                          </div>
