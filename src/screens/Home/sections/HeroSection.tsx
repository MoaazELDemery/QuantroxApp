    ...
    <section className="relative w-full bg-black min-h-[600px] h-[70vh] max-h-[800px] py-20">
      <div className="relative w-full max-w-5xl mx-auto px-4 h-full flex items-center">
        ...
        transform -translate-x-1/2 bg-[#ffffff01] overflow-hidden blur-[192px]">
          <div className="relative w-full max-w-5xl h-96 sm:h-[632px] left-8 sm:left-[126px] 
          bg-[linear-gradient(90deg,rgba(126,6,212,1)_0%,rgba(117,30,175,1)_100%)] opacity-20" />
        </div>
        <div className="absolute w-full max-w-lg h-px top-16 sm:top-[102px] left-1/2 
        transform -translate-x-1/2 bg-[linear-gradient(90deg,rgba(0,0,0,0)_0%,rgba(81,2,199,0.65)_50%,rgba(0,0,0,0)_100%)]" />
        <div className="absolute w-full max-w-xl h-32 sm:h-[200px] top-0 left-1/2 
        transform -translate-x-1/2 [background:radial-gradient(50%_50%_at_50%_50%,rgba(199,199,199,0.05)_0%,rgba(0,0,0,0)_70%)]" />
