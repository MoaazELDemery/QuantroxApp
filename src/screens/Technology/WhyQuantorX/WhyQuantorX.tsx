...
export const WhyQuantorX = (): JSX.Element => {
  ...
  return (
    <PageLayout>
      {/* Hero */}
      <PageHero
        eyebrow="Cognitive Mapping™  ·  Proprietary Technology"
        title={<>We Don't Install AI.<br />We Clone Expertise.</>}
        video="/videos/hero-neural.mp4"
        lede={
          <>
            <span className="block italic text-white/70 mb-4">
            ...
            <span className="block text-white/65 text-base">
        ...
        ctas={[
          { label: "Build Your Digital Expert", href: "/demo" },
          { label: "See How It Works", href: "#how-it-works", variant: "outline" },
        ]}
      >
        <div className="flex gap-5 justify-center flex-wrap opacity-70 text-xs font-semibold tracking-widest uppercase text-white/60">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-10 gap-y-10">
            {[
              ...
              <div key={step.num} className="border-t border-white/15 pt-6">
                <span
                  className="[font-family:'Satoshi-Black',Helvetica] font-black text-5xl leading-none block mb-4"
                  style={{ WebkitTextStroke: "1px rgba(155,92,246,0.45)", color: "transparent" }}
                  aria-hidden="true"
                >
                  {step.num}
                </span>
                <p className="[font-family:'Satoshi-Medium',Helvetica] text-[10px] uppercase tracking-[0.25em] text-[#9b5cf6] mb-2">
                  {step.tag}
                </p>
                <h3 className="[font-family:'Satoshi-Bold',Helvetica] font-bold text-white text-lg mb-2">{step.title}</h3>
                <p
                  className="[font-family:'Satoshi-Regular',Helvetica] font-normal leading-relaxed text-white/55 text-sm"
      ...
      <section className="px-4 sm:px-8 lg:px-16 xl:px-24 py-16 lg:py-24 bg-[#ffffff05]">
        <div className="max-w-7xl mx-auto">
          <div className="relative overflow-hidden rounded-[28px] border border-white/10 p-10 lg:p-16">
            {/* The fleet, standing behind the specification */}
            <img src="/worlds/fleet.webp" alt="" loading="lazy" className="absolute inset-0 w-full h-full object-cover object-right opacity-25" aria-hidden="true" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#08020e] via-[#08020e]/85 to-[#08020e]/40" aria-hidden="true" />
            <div className="absolute inset-x-8 top-0 h-px bg-gradient-to-r from-transparent via-[#9b5cf6]/60 to-transparent" aria-hidden="true" />
            <div className="relative">
              <p className="[font-family:'Satoshi-Medium',Helvetica] font-medium text-[#9b5cf6] text-xs uppercase tracking-[0.25em] mb-3">
                The Outcome
              </p>
              ...
              <p className="[font-family:'Satoshi-Regular',Helvetica] font-normal leading-relaxed text-white/70 text-lg mb-12 max-w-3xl">
              ...
              {/* The specification, as a numbered ledger */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-14">
                ...
                },
                {
                  ...
                  <div key={trait.title} className="border-t border-white/15 py-6">
                    <span
                      className="[font-family:'Satoshi-Black',Helvetica] font-black text-2xl leading-none block mb-3"
                      style={{ WebkitTextStroke: "1px rgba(155,92,246,0.5)", color: "transparent" }}
                      aria-hidden="true"
                    >
                      {`0${i + 1}`}
                    </span>
                    <h5 className="[font-family:'Satoshi-Bold',Helvetica] font-bold text-white text-base mb-2">
                      {trait.title}
                    </h5>
              ...
              {/* The finale - a statement, not a box */}
              <div className="border-t border-white/15 mt-2 pt-10">
                <p className="[font-family:'Satoshi-Bold',Helvetica] font-bold text-gradient-silver text-2xl lg:text-[2.1rem] leading-[1.2] tracking-[-0.01em] max-w-4xl pb-1">
                  It never resigns. Never leaves.
                  <br />
                  Never says &ldquo;let me get back to you.&rdquo;
                </p>
                <p className="[font-family:'Satoshi-Regular',Helvetica] text-white/60 text-base leading-relaxed mt-5 max-w-3xl">
                  No notice periods. No succession planning. No institutional knowledge walking out the door.
                  Available to every team member - at 2am on a Friday, on day one of Eid, the moment your most
                  senior person retires. <strong className="text-[#a679ff] [text-shadow:0_0_24px_rgba(155,92,246,0.4)]">Your expertise becomes infrastructure.</strong>
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="px-4 sm:px-8 lg:px-16 xl:px-24 py-16 lg:py-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 max-w-5xl mx-auto">
            {/* One ledger, split down the middle - no boxes */}
            <div className="sm:pr-12 sm:border-r sm:border-white/10">
              <h3 className="[font-family:'Satoshi-Medium',Helvetica] font-medium text-white/40 text-xs mb-2 uppercase tracking-[0.25em]">
              ...
              {[
                ...
                <div key={row} className="flex items-start gap-3 py-4 border-b border-white/[0.07] text-sm text-white/40">
                  <span className="text-white/25 flex-shrink-0 mt-0.5 font-bold">✗</span>
                  <span>{row}</span>
                </div>
              ))}
            </div>
            <div className="sm:pl-12 mt-10 sm:mt-0">
              <h3 className="[font-family:'Satoshi-Medium',Helvetica] font-medium text-[#9b5cf6] text-xs mb-2 uppercase tracking-[0.25em]" style={{ textShadow: "0 0 16px rgba(155,92,246,0.4)" }}>
              ...
              {[
                ...
                <div key={row} className="flex items-start gap-3 py-4 border-b border-white/[0.07] text-sm text-white/85">
                  <span className="flex-shrink-0 mt-0.5 font-bold text-[#9b5cf6]">✓</span>
                  <span>{row}</span>
                </div>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            {["Banking & Finance", "Government & Public Sector", "Telecom Operations", "Healthcare Providers", "Insurance", "Oil & Gas", "Legal Services", "Manufacturing", "Retail & FMCG", "Education"].map((chip) => (
              <span
                key={chip}
                className="glass-panel glass-hover rounded-full px-4 py-1.5 text-sm font-medium text-white/70 cursor-default"
              >
                {chip}
              </span>
            ))}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={pillar.title} className="glass-panel glass-hover rounded-[20px] p-6 hover:bg-[#ffffff12] transition-colors">
                <h3
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={cert.title} className="glass-panel glass-hover rounded-[20px] p-6 text-center">
          ...
          <PageCTA
      title={<>Your Best People Shouldn't Be Irreplaceable.</>}
      sub={<>Walk us through your most critical knowledge gap. We'll walk out with a plan to clone it. No commitment required.</>}
      primary={{ label: "Build My Digital Expert", href: "/demo" }}
    />
    </PageLayout>
  );
};
