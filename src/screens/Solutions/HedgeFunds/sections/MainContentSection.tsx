    ...
    <section className="w-full h-[750px] py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8">
      ...
      <div className="max-w-[1236px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          {/* Left Column - Heading */}
          <div className="opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:400ms] mb-8 lg:mb-0  w-full max-w-[600px] ">
            <h1 className="[font-family:'Satoshi-Bold',Helvetica] font-bold text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl tracking-[0] leading-tight text-center lg:text-left">
              From Idea to Live Algo Deployment.
            </h1>
          </div>
          ...
          <div className="opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:600ms]">
            <p className="[font-family:'Satoshi-Regular',Helvetica] font-normal text-[#d9d9d9] text-base sm:text-lg md:text-xl lg:text-2xl xl:text-[28px] tracking-[0] leading-relaxed text-center lg:text-left">
              A hedge fund developer designs a new multi-factor strategy. 
              Using Quantorx’s research environment, they test it with multiple data sets, 
              validate performance, and deploy it as a live algorithm. 
              The API ensures seamless integration with their existing systems, 
              while the platform continuously monitors performance and risk exposure.
            </p>
          </div>
        </div>
      </div>
