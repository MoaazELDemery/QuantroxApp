...
export const ChallengesSection = (): JSX.Element => {
  return (
    <section className="relative w-full min-h-screen h-[100vh] overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 w-full h-full flex items-center justify-center [background:radial-gradient(50%_50%_at_50%_0%,rgba(74,0,130,0.5)_0%,rgba(0,0,0,0)_100%)]">
        ...
        {/* Main Content */}
        <main className="flex flex-col items-center justify-center gap-6 sm:gap-8 max-w-[1001px] mx-auto px-6 sm:px-8 pt-20 sm:pt-24 md:pt-0">
