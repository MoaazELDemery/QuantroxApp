  ...
  const challenges = [
    {
      title: "Challenge 1",
      description:
        "Need for a secure environment to run proprietary strategies.",
    },
    {
      title: "Challenge 2",
      description:
        "Fragmented tools that limit research and execution speed.",
    },
    {
      title: "Challenge 3",
      description:
        "The constant demand for innovation in alpha generation.",
    },
  ];
    ...
    <section className="w-full py-[100px] flex flex-col items-center">
      ...
      <div className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms] flex w-full max-w-[1096px] flex-col items-center gap-6 mt-[67px]">
        ...
        <p className="flex items-center justify-center text-center [font-family:'Satoshi-Medium',Helvetica] font-medium text-[#d9d9d9] text-[28px] tracking-[0] leading-[normal]">
          The obstacles hedge funds face when testing, deploying, and securing sophisticated strategies
        </p>
      </div>
