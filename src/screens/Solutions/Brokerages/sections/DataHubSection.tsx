...
export const DataHubSection = (): JSX.Element => {
  return (
    <section className="w-full flex flex-col py-12 md:py-16 lg:py-[100px] px-4 sm:px-6 md:px-8">
      <div className="flex justify-center items-center gap-3 sm:gap-[15px] px-[15px] py-0 rounded-[150px] 
      overflow-hidden opacity-60 translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:0ms]">
        <div className="w-[40px] sm:w-[60px] h-[1.5px] rounded-[90px] 
      ...
      <div className="flex flex-col items-center gap-4 sm:gap-6 mt-8 sm:mt-12 md:mt-[67px] max-w-[1096px] 
      ...
      <div className="flex flex-col gap-8 sm:gap-10 md:gap-12 mt-12 sm:mt-16 md:mt-[89px] max-w-[1400px] mx-auto w-full">
        {solutionsData.map((solution, index) => {
          ...
          return (
            <div
              key={solution.id}
              className={`flex w-full justify-center lg:${alignment} ${extraMargin} translate-y-[-1rem] 
            ...
            >
              <div className="w-full max-w-[570px] relative px-4 text-center lg:text-left">
                <div className="h-auto mb-3 [font-family:'Satoshi-Medium',Helvetica] font-medium 
                     text-[#6e6179] text-sm sm:text-base tracking-[0] leading-[normal]">
                  {solution.label}
                </div>
                <div className="mb-4 sm:mb-6 h-auto [font-family:'Satoshi-Medium',Helvetica] 
                     font-medium text-[#ffffff] text-xl sm:text-2xl md:text-3xl lg:text-[34px] tracking-[0] 
                     leading-tight">
                  {solution.title}
                </div>
                <Card className="w-full max-w-[545px] mx-auto lg:mx-0 h-auto border-0 bg-transparent">
                  <CardContent className="p-4 sm:p-6 lg:p-0 w-full h-full flex relative min-h-[140px] 
                       sm:min-h-[160px] lg:min-h-[152px] rounded-lg lg:rounded-none">
                    <div className="mt-2 sm:mt-4 lg:mt-7 w-full max-w-[489px] h-auto lg:ml-7 
                         bg-gradient-to-r from-purple-900/10 to-indigo-900/10 backdrop-blur-sm rounded-lg 
                         p-4 sm:p-5 lg:p-6 [font-family:'Satoshi-Regular',Helvetica] font-normal text-[#d9d9d9] 
                         text-sm sm:text-base lg:text-lg xl:text-xl tracking-[0] leading-relaxed flex items-center">
