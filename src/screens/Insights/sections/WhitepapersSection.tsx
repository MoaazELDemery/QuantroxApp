    ...
    <section className="w-full py-8 px-2 sm:px-4 md:px-8 lg:px-16 xl:px-24">
      <div className="max-w-5xl mx-auto flex flex-col items-start gap-8">
        <div className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:0ms]">
          <h2 className="[font-family:'Satoshi-Bold',Helvetica] font-bold text-[#ffffff] text-3xl 
            ...
            >
              <CardContent className="p-4 sm:p-6 h-full flex flex-col justify-between">
                <div className="flex flex-col gap-2.5">
                  <h3 className="[font-family:'Satoshi-Medium',Helvetica] font-medium text-[#ffffff] 
                ...
                {/* <div className="flex items-center justify-between mt-6">
                  ...
                  <Button
                    variant="ghost"
                    className="h-auto p-0 text-[#8a2be2] text-[18.4px] [font-family:'Satoshi-Medium',Helvetica] 
                    font-medium hover:text-[#8a2be2]/80 transition-colors"
                  >
