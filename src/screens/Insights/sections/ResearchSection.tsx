  ...
  return (
    <section className="w-full h-[450px] flex items-center justify-center py-16">
      ...
      lg:justify-between gap-8 px-4">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6 flex-shrink-0 
        translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
          ...
          <button className="px-12 py-3 h-auto bg-[#4a0082] rounded-[32px] hover:bg-[#4a0082]/90 
          transition-colors">
