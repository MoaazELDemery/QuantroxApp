    ...
    <section className="w-full flex items-center justify-center py-16">
      <div className="flex flex-col lg:flex-row max-w-[1248px] w-full items-center justify-center lg:justify-between gap-8 px-4">
        <div className="flex flex-col max-w-[658px] w-full items-center lg:items-start justify-between gap-6 translate-y-[-1rem] animate-fade-in opacity-0 text-center lg:text-left">
          ...
          <p className="[font-family:'Satoshi-Regular',Helvetica] font-normal text-[#d9d9d9] text-2xl tracking-[0] leading-[normal] w-full">
            Understand how Quantorx can be configured to solve your specific
            execution, research, and risk challenges.
          </p>
        </div>

        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6 flex-shrink-0 translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
          <input
            type="email"
