    ...
    <section className="w-full py-10 px-2 sm:px-4 relative">
      <div className="flex flex-col items-center gap-8 max-w-full mx-auto">
        <div className="flex flex-col items-center justify-center gap-6 w-full">
          ...
          <p className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms] 
        ...
        rounded-[32px] hover:bg-[#5a0092] transition-colors">
          ...
          text-[#ffffff] text-base sm:text-lg text-center tracking-[0] leading-6 whitespace-nowrap">
            Contact Us
          </span>
        </Button>
      </div>
