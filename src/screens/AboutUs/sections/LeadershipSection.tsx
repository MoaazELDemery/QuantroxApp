  ...
  return (
    <section className="flex flex-col items-start gap-2 px-2 sm:px-4 py-16 w-full">
      <div className="flex flex-col items-start gap-12 w-full">
        <h2 className="flex items-center justify-center w-full [font-family:'Satoshi-Bold',Helvetica] 
        font-bold text-[#ffffff] text-2xl sm:text-4xl md:text-5xl text-center tracking-[0] leading-[normal]">
          Our Leadership
        </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full max-w-6xl mx-auto">
          {leadershipData.map((leader, index) => (
            <Card
              ...
              className="flex flex-col h-full min-h-[420px] rounded-2xl overflow-hidden border-[0.2px] 
              border-solid border-[#6e6179] bg-transparent"
            >
