...
export const ResearchEnvironmentSection = (): JSX.Element => {
  return (
    <section className="relative w-full min-h-[560px] md:min-h-[700px] overflow-visible pb-0">
      ...
      {/* Main Content */}
      <main className="flex flex-col items-center justify-center gap-6 sm:gap-8 max-w-[1001px] 
      mx-auto px-6 sm:px-8 pt-32 sm:pt-40 md:pt-48 lg:pt-56 xl:pt-64 pb-0">
        <div className="flex flex-col items-center gap-8 translate-y-[-1rem] animate-fade-in opacity-0 
