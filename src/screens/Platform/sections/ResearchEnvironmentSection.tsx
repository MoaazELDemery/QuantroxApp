export const ResearchEnvironmentSection = (): JSX.Element => {
  return (
    <section className="relative w-full h-[850px] overflow-hidden">
      ...
      {/* Main Content */}
      <main className="flex flex-col items-center justify-center gap-6 sm:gap-8 max-w-[1001px] mx-auto px-6 sm:px-8 pt-20 sm:pt-24 md:pt-32 lg:pt-40 xl:pt-48 min-h-[calc(100vh-120px)]">
